...
public class PetController {
    ...
    @GetMapping("/list") public String listPets(HttpSession session, ModelMap model) {
    ...
    @PostMapping("/delete") public String deletePet(HttpSession session, @RequestParam String id) {
        UserDto loggedUser = (UserDto) session.getAttribute("loggedUser");
        if (loggedUser == null) {
            return "redirect:/login";
        }
